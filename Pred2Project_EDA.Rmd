...
Garbage_Carts <- read_csv("~/z/Grocery Stores/420 - Predictive II/Aggregated Data/311_Service_Requests_-_Garbage_Carts.csv")
Sanitation <- read_csv("~/z/Grocery Stores/420 - Predictive II/Aggregated Data/311_Service_Requests_-_Sanitation_Code_Complaints.csv")
Business_Licenses <- read_csv("~/z/Grocery Stores/420 - Predictive II/Aggregated Data/Business_Licenses.csv")
Food_Inspections <- read_csv("~/z/Grocery Stores/420 - Predictive II/Aggregated Data/Food_Inspections.csv")
...
linear_model <- glm(ModelData$Results_Numeric ~  factor(ModelData$inspection_month) +  ModelData$Num_Sanitation_Requests  + ModelData$Num_Garbage_Requests)
